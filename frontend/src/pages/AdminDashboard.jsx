  ...
  return (
    <div className="flex min-h-screen bg-gray-900 text-white">
      ...
      >
        ...
        <h1 className="text-center text-xl font-bold pb-2 border-b border-gray-700">Admin Panel</h1>
      ...
      <div className={`flex-1 p-6 ${sidebarOpen ? "ml-64" : "ml-0"} transition-all duration-300`}>
        {!sidebarOpen && (
          <div>
            ...
            <h2 className="text-3xl font-bold mb-4 mt-2 ml-16">Admin Dashboard</h2>
          </div>
        )}
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg border border-gray-700">
          ...
          {activeTab === "employee" && <Employees />}
          {activeTab === "attendance" && <Attendance />}
          {activeTab === "leave" && <LeaveAdmin />}
